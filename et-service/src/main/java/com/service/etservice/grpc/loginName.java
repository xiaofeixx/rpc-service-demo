...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.service.etservice.grpc.UserPhoto.internal_static_hallo_loginName_descriptor;
  }

  @Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.service.etservice.grpc.UserPhoto.internal_static_hallo_loginName_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            loginName.class, Builder.class);
  }
  ...
  public static loginName parseFrom(
  ...
  public static loginName parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static loginName parseFrom(
  ...
  public static loginName parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static loginName parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static loginName parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(loginName prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.service.etservice.grpc.loginName.newBuilder()
    private Builder() {
    ...
    @Override
    public loginName getDefaultInstanceForType() {
      return loginName.getDefaultInstance();
    }

    @Override
    public loginName build() {
      loginName result = buildPartial();
    ...
    @Override
    public loginName buildPartial() {
      loginName result = new loginName(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof loginName) {
        return mergeFrom((loginName)other);
      } else {
    ...
    public Builder mergeFrom(loginName other) {
      if (other == loginName.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      loginName parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (loginName) e.getUnfinishedMessage();
  ...
  private static final loginName DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new loginName();
  }

  public static loginName getDefaultInstance() {
